...
feature_vectors_binary = open('analysis_feature_vectors_test.txt', 'w')  # #######################################
feature_vectors_binary_filename = open('analysis_filename_test.txt', 'w')

features_5 = dict()

features = dict()
features_dict = open('trigrams_test')
...
for filename in glob.glob('testing/*.txt'):
    ...
    for trigram in trigrams:
        ...
        # features[trigram] = 1
        if trigram in features_5:
            features_5[trigram] = features_5[trigram] + 1
        else:
            features_5[trigram] = 0
